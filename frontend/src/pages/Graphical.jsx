...
import Graphical from "../methods/Graphical";
...
export default function BisectionPage() {
  ...
  const handleCalculate = () => {
    ...
    try {
      const method = new Graphical(func);
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.header}>Graphical Method</h2>
      ...
      {result && (
        <div style={styles.result}>
          ...
          <ResultTable iterations={result.iterations} columnKey="x" />
